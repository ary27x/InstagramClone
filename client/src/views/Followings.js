...
axios.post("/followings",{username},{headers:{
    authorization : token
}}).then(data => {
    ...
    return(
      ...
      <div class="card " style={{maxWidth:"600px",margin:"20px auto"}}>
        <div style={{display:"flex",justifyContent:'center',backgroundColor:"#039be5",height:"60px"} }>
          <span class="card-title" style={{textAlign:"center",color:'white',paddingTop:'10px'}}>Followings</span>
        </div>
...
style={{display:"flex",alignItems:'center',paddingBottom:'10px'}}
            ...
            >
                <p style={{marginLeft:'6px'}}>No followings</p>
                </div></> : ""}
        </div>
